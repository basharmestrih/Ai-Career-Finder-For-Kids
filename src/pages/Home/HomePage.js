                ...
                <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
                  {activeStep === 3 ? (
                    <button
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-white px-8 py-3 text-xs font-bold text-slate-600 transition-all hover:bg-slate-50 active:scale-95 sm:w-auto"
                    >
                      Skip
                    </button>
                  ) : null}
